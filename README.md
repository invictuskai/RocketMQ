...
编译完成之后在 distribution/target/rocketmq-5.1.4/rocketmq-5.1.4/bin目录下
* 执行 ./mqnamesrv 启动namesrv
* 执行 ./mqbroker -n localhost:9876  启动broker
* 执行 ./tools.sh org.apache.rocketmq.example.quickstart.Producer 测试发送脚本
* 执行 ./tools.sh org.apache.rocketmq.example.quickstart.Consumer 测试接收脚本
* 执行 ./mqshutdown namesrv 关闭namesrv
* 执行 ./mqshutdown broker 关闭broker
### 报错处理
java.lang.IllegalStateException: org.apache.rocketmq.remoting.exception.RemotingConnectException: connect to null failed

修改tools.sh，指定namesrv的地址：export NAMESRV_ADDR=127.0.0.1:9876